    ...
    <div className="video-container">
      ...
      <div className="section-container">
        <motion.div
          ...
          <p>
            <ParagraphEffect
              text="Welcome to my corner of the web! I’m a dedicated web developer with expertise in HTML, CSS, JavaScript, React, and more. I bring creativity and technical skill to every project,
                     ensuring a seamless and engaging user experience."
              speed={50}
            />
          </p>
          <a
            href="/images/Feranmi_Ayoola_Jegede_FullStack_Web3_CV.pdf"
            download="My Resume"
            className="resume">
